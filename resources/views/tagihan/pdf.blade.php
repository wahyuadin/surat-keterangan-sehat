...
<head>
    ...
    <style>
        ...
        /* ===== CSS WATERMARK BARU DITAMBAHKAN ===== */
        .watermark {
            position: fixed;
            top: 50%;
            left: 50%;
...
<body>
                ...
                <table style="border-collapse: collapse;">
                    <tr>
                        <td style="padding-right: 15px; vertical-align: middle;">
                            <img class="logo" src="{{ asset('assets/pdf/1.jpg') }}" alt="Logo" style="width: 100px; display: block;">
                        </td>
        ...
        <tr>
            ...
            <td style="width:50%; text-align:right; vertical-align: top;">
                ...
                <p>{{ \Carbon\Carbon::parse($data->dari)->isoFormat('D MMMM Y') }}
                    &mdash;
                    {{ \Carbon\Carbon::parse($data->sampai)->isoFormat('D MMMM Y') }}
                </p>
            </td>
        </tr>
    </table>
    ...
    <div style="width: 40%; margin-left: 60%; margin-top: 60px; text-align: center;">
        ...
        <img src="{{ asset('storage/' . Auth::user()->avatar) }}" alt="" style="width: 150px">
