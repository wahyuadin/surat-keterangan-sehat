<div class="modal fade" id="addModalPatient" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="addModalPatientLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg modal-dialog-centered">
        <div class="modal-content">
            <form action="{{ route('patient.store') }}" method="POST">
                @csrf
                <div class="modal-header">
                    <h1 class="modal-title fs-5" id="addModalPatientLabel">Tambah Data Pasien</h1>
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="alamat" id="alamat" class="form-control" rows="3" placeholder="Masukkan alamat pasien (opsional)">{{ old('alamat') }}</textarea>
                    </div>
                </div>
