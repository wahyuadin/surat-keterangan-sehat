  ...
  <div class="modal-dialog modal-dialog-centered modal-md">
    ...
    <div class="modal-body text-center py-2">
        <h3 class="mb-0 p-3 fs-4" style="line-height: 1.5;">
            Pastikan sebelum memasukkan data <b>perusahaan</b>, lakukan pengecekan terlebih dahulu apakah data tersebut sudah ada atau belum dengan menggunakan tombol pencarian. Duplikasi data bisa menimbulkan masalah pada data.
        </h3>
    </div>
